...
Checkpoint 1 is provisionally promoted under an explicit reconstructed-provenance waiver. Checkpoint 2 and D-007 through D-009 are approved. The Pi pilot at `v0.80.6` / `2b3fda9921b5590f285165287bd442a25817f17b` and OpenHands Software Agent SDK at `v1.35.0` / `9028562e2d5eda76de662ec9b7584125760eb83f` are maintainer-reviewed cases. Only the OpenClaw case at `v2026.6.6` / `8c802aa683510c7f7503597b54c3021733245e59` is authorized next, beginning with a written scope boundary before deep analysis. LangGraph is deferred to a future framework/substrate comparison because it does not answer the current concrete-harness case question. Browser Use, Claude Code, Hermes, every alternate, and every replacement for the LangGraph slot remain blocked. After OpenClaw, pause for an interim maintainer sampling-strategy review; do not treat it as Checkpoint 3 or silently resize the batch. The eleven-responsibility lens remains provisional until Checkpoint 3 consolidates taxonomy friction across the first batch.
