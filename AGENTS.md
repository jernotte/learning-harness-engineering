...
Checkpoint 1 is provisionally promoted under an explicit reconstructed-provenance waiver. Checkpoint 2 and D-007 are approved. The Pi pilot at `v0.80.6` / `2b3fda9921b5590f285165287bd442a25817f17b` is a maintainer-reviewed case. Only the OpenHands Software Agent SDK case at `v1.35.0` / `9028562e2d5eda76de662ec9b7584125760eb83f` is authorized next, beginning with a written scope boundary before deep analysis. LangGraph, Browser Use, OpenClaw, Claude Code, and every alternate remain blocked. The eleven-responsibility lens remains provisional until Checkpoint 3 consolidates taxonomy friction across the first batch.
