...
Checkpoint 1 is provisionally promoted under an explicit reconstructed-provenance waiver. Checkpoint 2 and D-007 through D-014 are approved. Pi at `v0.80.6` / `2b3fda9921b5590f285165287bd442a25817f17b`, OpenHands Software Agent SDK at `v1.35.0` / `9028562e2d5eda76de662ec9b7584125760eb83f`, OpenClaw at `v2026.6.6` / `8c802aa683510c7f7503597b54c3021733245e59`, and Hermes Agent at `v2026.7.7.2` / `9de9c25f620ff7f1ce0fd5457d596052d5159596` are maintainer-reviewed cases. Gate B is approved. The maintainer rejected the first “Where Harnesses Put Control” learning pilot as too abstract and shallow; it is not an accepted learning artifact. D-014 authorizes the replacement context-management synthesis, Markdown, and Codex-generated site, including bounded topic-specific inspection of pinned Codex and Letta evidence without promoting them to full cases. The replacement awaits maintainer reading, and capacity-blocked Fable review is explicitly deferred rather than passed. The deterministic Codex writer and separate isolated Fable-high writer remain distinct authoring implementations; the Fable review workflow remains a third, read-only role. Neither writer may modify canonical research or learning Markdown. Do not add another full implementation before the replacement learning checkpoint. LangGraph remains deferred to a future framework/substrate comparison; Browser Use remains deferred rather than discarded; Claude Code remains secondary reporting until a stable evidence set is admitted; every cohort member, alternate, and replacement for the LangGraph slot remains blocked.
