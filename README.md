...
The structure remains intentionally small. The maintainer has reviewed the Pi and OpenHands SDK cases and authorized only pinned OpenClaw next, with a written scope boundary required before deep analysis. Source-native topics may later add navigation without forcing the responsibility lens into an exclusive directory tree.
