...
**Status:** Adversarially reviewed checkpoint-01 baseline; historical input to
F and G, not current governing authority
**Authority:** V2-D013
...
V2-D014 produced reviewed predecessor
[`V2-SK-F`](conventional-buildup-skeleton.md). V2-D015 now makes
[`V2-SK-G`](governing-structure.md) the sole governing high-level structure.
This document remains the reviewed conventional-topic baseline in that lineage.
