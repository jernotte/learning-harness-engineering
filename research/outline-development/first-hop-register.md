...
Opened rows remain structural inputs rather than promoted evidence; withdrawn
rows remain unopened leads with no priority. The complete pinned-catalog census
and later maintainer-approved source-opening batches now control Stage 4.
...
## Withdrawn Wave 2 proposal — never approved or opened

| Source-family ID | Candidate | Direct seed attribution | Exact direct-hop evidence | Proposed wave | Approving checkpoint | Unresolved outline decision | Selection reason | Resolution query | Opened |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `wave2-long-running-generator-evaluator` | Prithvi Rajasekaran, *Building long-running agentic applications: the generator/evaluator pattern* | `v2-seed-asixiv-2606-00001` | Seed PDF, page 11, reference [4]; source is also the named basis for the seed's generator/evaluator section | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | Should longitudinal verification, handoff, persistence, and stopping form one cross-cutting control strand rather than separate component chapters? | Historical rationale: a first-party long-running-application account could test whether the seed's strongest lifecycle claim survives inspection of its named source and whether operation should shape the outline spine | Canceled; no query used | No |
| `wave2-stripe-minions` | Steve Kaliski, *Stripe's Minions: 1,300 PRs a week* | `v2-seed-asixiv-2606-00001` | Seed PDF, page 11, reference [5]; named enterprise case in the abstract and operational examples | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | Must operating model, throughput, review economics, and retained human authority appear in the main knowledge architecture rather than a terminal operations section? | Historical rationale: this named operator account could challenge the coding-practice concentration with a distinct organization and expose which scale claims are structural versus anecdotal | Canceled; no query used | No |
| `wave2-cognitive-architectures` | Sumers et al., [*Cognitive Architectures for Language Agents*](https://arxiv.org/abs/2309.02427) | `v2-seed-local-2606-24937v1` | Local PDF, bibliography entry [329], page 598; cited in the book's memory and agent-architecture framing | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | Does a model-inspired cognitive-architecture frame materially improve the harness boundary and responsibility vocabulary, or does it over-center model cognition? | Historical rationale: an older peer-reviewed conceptual lineage could counter the 2026 coding-harness framing and test whether memory, action, decision, and learning should be responsibilities, interfaces, or exclusions | None used | No |
| `wave2-mcp-specification` | [Model Context Protocol specification](https://modelcontextprotocol.io) | `v2-seed-asixiv-2606-00001`; `v2-seed-local-2606-24937v1` | Seed PDF, page 11, reference [6]; local PDF, Chapter 18 MCP treatment and bibliography entry [335], page 598 | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | Where should external capability protocols and host–client–server trust boundaries live without turning the outline into a standards or tool catalog? | Historical rationale: a primary specification with two-seed attribution could test protocols as an interface or cross-cutting concern and reduce reliance on vendor retrospectives or curator categories | None used | No |
| `wave2-gaia-benchmark` | Mialon et al., [*GAIA: A Benchmark for General AI Assistants*](https://arxiv.org/abs/2311.12983) | `v2-seed-local-2606-24937v1` | Local PDF, §29.3.3, page 576, and bibliography entry [362], page 600 | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | How early must task success, tool-use evidence, cost, and cross-domain transfer requirements constrain the outline and its later research questions? | Historical rationale: a general-assistant benchmark could supply a non-vendor, non-coding evaluation frame and test whether evidence and evaluability belong before architecture choice | None used | No |
| `wave2-indirect-prompt-injection` | Greshake et al., *Not What You've Signed up for: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection* | `v2-seed-local-2606-24937v1` | Local PDF, §29.2.5 and §29.3.4, pages 575–576, and bibliography entry [408], page 603 | Withdrawn Wave 2 | Never approved; withdrawn by V2-D007 | Should trust boundaries and adversarial environmental input be a cross-cutting design constraint or a failure-first traversal, and where does adjacent security stop? | Historical rationale: a concrete adverse source could challenge happy-path and coding bias while testing the adjacent-security boundary; the maintainer later specifically questioned its indirect relevance | Canceled; no query used | No |

The proposal used two asixiv-only leads, three book-only leads, and one shared
lead. It was withdrawn before approval. None of its sources or identity queries
was opened or executed, and its former cap arithmetic has no active authority.
...
## Historical Wave 2 rationale and withdrawal

The withdrawn proposal targeted questions thought most likely to alter the primary
...
tested the Wave 1 pressure toward a constraints-to-decisions journey rather than
collecting more mechanism categories.

It would still not have established representative domain coverage, balance
...
limited direct effect. More importantly, it left the maintainer-named Awesome
catalog largely unevaluated. V2-D007 therefore withdrew the proposal and
replaced sampling with a complete pinned-catalog inventory and gate.
...
The three former Wave 2 query intentions were canceled by V2-D007. They were
never executed and do not enter this log.

## Current catalog rules

- Every qualifying outbound occurrence in the pinned Awesome README enters the
  machine-readable catalog, whether or not it is later recommended for opening.
- Deduplication preserves every category occurrence and unresolved alias.
- Catalog-context triage is not direct source evaluation or a provenance
  disposition.
- Before any new outbound family is opened, the maintainer reviews the complete
  census and exact proposed source-opening batches at the catalog gate.
