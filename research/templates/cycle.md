...
State a bounded question whose answer could improve harness design or evaluation.
...
Record emerging comparison axes, provisional findings, contradictions, duplicate evidence chains, and questions that have sent the cycle back to recon or analysis.

## Refinement and saturation review

Before stopping, address:

- What conclusions survived source checks and counterexample searches?
- Which patterns are observed, supported, contextual, emerging, contested, or anti-patterns?
- Are material claims traceable to evidence?
- Have important contradictions been resolved or bounded?
...
Explain what improved or harmed research quality, whether schemas should change, where agent work duplicated or drifted, and what the next cycle should do differently.

## Checkpoint record

Use one row per review so approval of one artifact cannot be mistaken for approval of the entire cycle.
